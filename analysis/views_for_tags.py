...
#        return render_to_response('charts_new.html',{'data':json.dumps(datalist)})
#        return render_to_response('charts_backup_2_with_AJaX_pie_bar.html',{'data':json.dumps(datalist)})
        return render_to_response('charts_backup_1.html',{'data':json.dumps(datalist)})


        #return render_to_response('charts_new.html',json.dumps(sending_data))
        #return render_to_response('charts_new.html')
